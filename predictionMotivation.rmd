...
exerData <- read.csv("C:/Neelima/Coursera/Assignments/data/pml-training.csv", header = TRUE, na.strings = c("NA", ""))
exerData_test <- read.csv("C:/Neelima/Coursera/Assignments/data/pml-testing.csv", header = TRUE, na.strings = c("NA", ""))
```
